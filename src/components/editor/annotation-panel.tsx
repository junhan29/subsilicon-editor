  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 mb-1.5">
        ...
        <span className="text-[11px] font-medium text-foreground truncate">{annotation.author}</span>
        <span className="text-[10px] text-muted-foreground ml-auto shrink-0">{formatRelativeTime(annotation.createdAt)}</span>
      </div>

      {/* 文本 */}
      <p className="text-xs text-foreground leading-relaxed whitespace-pre-wrap break-words">{annotation.text}</p>

      {/* 回复列表 */}
      {annotation.replies && annotation.replies.length > 0 && (
        <div className="mt-2 space-y-1.5 pl-3 border-l border-border/60">
          {annotation.replies.map((reply) => (
            <div key={reply.id} className="text-xs">
              ...
              <p className="text-muted-foreground mt-0.5 ml-4 whitespace-pre-wrap break-words">{reply.text}</p>
            </div>
          ))}
        </div>
      )}
      ...
      {showReply && (
        <div className="mt-2">
          <textarea
            ...
            className="w-full min-h-[50px] max-h-[100px] resize-none text-xs bg-card border border-border rounded px-2 py-1.5 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-slate-500"
          />
        </div>
      )}
      ...
      <div className="flex items-center gap-1 mt-2">
        <button
          ...
          className="flex items-center gap-1 px-1.5 py-0.5 text-[10px] text-muted-foreground hover:text-foreground hover:bg-secondary/50 rounded transition-colors"
          title="回复"
        >
        ...
        <button
          ...
          className="flex items-center gap-1 px-1.5 py-0.5 text-[10px] text-muted-foreground hover:text-emerald-400 hover:bg-emerald-500/10 rounded transition-colors"
        ...
        <button
          ...
          className="flex items-center gap-1 px-1.5 py-0.5 text-[10px] text-muted-foreground hover:text-red-400 hover:bg-primary/10 rounded transition-colors ml-auto"
          title="删除批注"
        >
  ...
  return (
    <div className="rounded-lg border border-border bg-muted/50 p-2.5 space-y-2">
      ...
      <textarea
        ...
        className="w-full min-h-[60px] max-h-[120px] resize-none text-xs bg-card border border-border rounded px-2 py-1.5 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-slate-500"
      />
      ...
      <input
        ...
        className="w-full text-[11px] bg-card border border-border rounded px-2 py-1 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-slate-500"
      />
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={!text.trim()}
          className="flex-1 flex items-center justify-center gap-1 px-2 py-1 text-[11px] bg-blue-600 hover:bg-blue-500 disabled:bg-secondary disabled:text-muted-foreground text-white rounded transition-colors"
        >
        ...
        <button
          onClick={onCancel}
          className="px-2 py-1 text-[11px] bg-secondary hover:bg-accent text-foreground rounded transition-colors"
        >
          取消
        </button>
      </div>
