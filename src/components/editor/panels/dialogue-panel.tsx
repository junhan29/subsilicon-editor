...
import { Eye, Image, Move, Music, Sparkles, Square, Type, X } from 'lucide-react'
import { Toggle } from '@editor/components/ui/toggle'
import type { BasePanelProps } from './shared-props'
import { DIALOG_COLOR_OPTIONS, DIALOG_STYLE_TYPES, ENTER_ANIMATION_TYPES, SPRITE_POSITION_TYPES, TEXT_ANIMATION_TYPES } from './shared-props'
