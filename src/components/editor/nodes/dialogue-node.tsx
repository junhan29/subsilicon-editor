  ...
  return (
    ...
    >
      ...
      <Handle
        ...
        className="!w-4 !h-4 !rounded-full !z-20 !bg-violet-500 !border-2 !border-card !-bottom-2 !transition-all hover:!scale-125 hover:!shadow-lg hover:!shadow-violet-500/30 dark:!bg-violet-400 dark:!border-slate-900"
      />
    </div>
  )
}
